...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PremiseNameType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PremiseNumberPrefixType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PremiseNumberRangeType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseName <em>Premise Name</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseLocation <em>Premise Location</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseNumber <em>Premise Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseNumberRange <em>Premise Number Range</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseNumberPrefix <em>Premise Number Prefix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseNumberSuffix <em>Premise Number Suffix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getBuildingName <em>Building Name</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getSubPremise <em>Sub Premise</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getFirm <em>Firm</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getMailStop <em>Mail Stop</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremise <em>Premise</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseDependency <em>Premise Dependency</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseDependencyType <em>Premise Dependency Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getPremiseThoroughfareConnector <em>Premise Thoroughfare Connector</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PremiseTypeImpl extends MinimalEObjectImpl.Container implements PremiseType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPremiseType();
	}
	...
	public EList<AddressLineType> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLineType>(AddressLineType.class, this, _0Package.PREMISE_TYPE__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public EList<PremiseNameType> getPremiseName() {
		if (premiseName == null) {
			premiseName = new EObjectContainmentEList<PremiseNameType>(PremiseNameType.class, this, _0Package.PREMISE_TYPE__PREMISE_NAME);
		}
		return premiseName;
	}
	...
	public NotificationChain basicSetPremiseLocation(PremiseLocationType newPremiseLocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_LOCATION, oldPremiseLocation, newPremiseLocation);
	...
	public void setPremiseLocation(PremiseLocationType newPremiseLocation) {
		if (newPremiseLocation != premiseLocation) {
			...
			if (premiseLocation != null)
				msgs = ((InternalEObject)premiseLocation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE_LOCATION, null, msgs);
			if (newPremiseLocation != null)
				msgs = ((InternalEObject)newPremiseLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE_LOCATION, null, msgs);
			msgs = basicSetPremiseLocation(newPremiseLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_LOCATION, newPremiseLocation, newPremiseLocation));
	}
	...
	public EList<PremiseNumberType> getPremiseNumber() {
		if (premiseNumber == null) {
			premiseNumber = new EObjectContainmentEList<PremiseNumberType>(PremiseNumberType.class, this, _0Package.PREMISE_TYPE__PREMISE_NUMBER);
		}
	...
	public NotificationChain basicSetPremiseNumberRange(PremiseNumberRangeType newPremiseNumberRange, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_NUMBER_RANGE, oldPremiseNumberRange, newPremiseNumberRange);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPremiseNumberRange(PremiseNumberRangeType newPremiseNumberRange) {
		if (newPremiseNumberRange != premiseNumberRange) {
			...
			if (premiseNumberRange != null)
				msgs = ((InternalEObject)premiseNumberRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE_NUMBER_RANGE, null, msgs);
			if (newPremiseNumberRange != null)
				msgs = ((InternalEObject)newPremiseNumberRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE_NUMBER_RANGE, null, msgs);
			msgs = basicSetPremiseNumberRange(newPremiseNumberRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_NUMBER_RANGE, newPremiseNumberRange, newPremiseNumberRange));
	}
	...
	public EList<PremiseNumberPrefixType> getPremiseNumberPrefix() {
		if (premiseNumberPrefix == null) {
			premiseNumberPrefix = new EObjectContainmentEList<PremiseNumberPrefixType>(PremiseNumberPrefixType.class, this, _0Package.PREMISE_TYPE__PREMISE_NUMBER_PREFIX);
		}
	...
	public EList<PremiseNumberSuffixType> getPremiseNumberSuffix() {
		if (premiseNumberSuffix == null) {
			premiseNumberSuffix = new EObjectContainmentEList<PremiseNumberSuffixType>(PremiseNumberSuffixType.class, this, _0Package.PREMISE_TYPE__PREMISE_NUMBER_SUFFIX);
		}
	...
	public EList<BuildingNameType> getBuildingName() {
		if (buildingName == null) {
			buildingName = new EObjectContainmentEList<BuildingNameType>(BuildingNameType.class, this, _0Package.PREMISE_TYPE__BUILDING_NAME);
		}
		return buildingName;
	}
	...
	public EList<SubPremiseType> getSubPremise() {
		if (subPremise == null) {
			subPremise = new EObjectContainmentEList<SubPremiseType>(SubPremiseType.class, this, _0Package.PREMISE_TYPE__SUB_PREMISE);
		}
		return subPremise;
	}
	...
	public NotificationChain basicSetFirm(FirmType newFirm, NotificationChain msgs) {
		...
		firm = newFirm;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__FIRM, oldFirm, newFirm);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFirm(FirmType newFirm) {
		if (newFirm != firm) {
			NotificationChain msgs = null;
			if (firm != null)
				msgs = ((InternalEObject)firm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__FIRM, null, msgs);
			if (newFirm != null)
				msgs = ((InternalEObject)newFirm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__FIRM, null, msgs);
			msgs = basicSetFirm(newFirm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__FIRM, newFirm, newFirm));
	}
	...
	public NotificationChain basicSetMailStop(MailStopType newMailStop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__MAIL_STOP, oldMailStop, newMailStop);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMailStop(MailStopType newMailStop) {
		if (newMailStop != mailStop) {
			NotificationChain msgs = null;
			if (mailStop != null)
				msgs = ((InternalEObject)mailStop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__MAIL_STOP, null, msgs);
			if (newMailStop != null)
				msgs = ((InternalEObject)newMailStop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__MAIL_STOP, null, msgs);
			msgs = basicSetMailStop(newMailStop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__MAIL_STOP, newMailStop, newMailStop));
	}
	...
	public NotificationChain basicSetPostalCode(PostalCodeType newPostalCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__POSTAL_CODE, oldPostalCode, newPostalCode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostalCode(PostalCodeType newPostalCode) {
		if (newPostalCode != postalCode) {
			NotificationChain msgs = null;
			if (postalCode != null)
				msgs = ((InternalEObject)postalCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__POSTAL_CODE, null, msgs);
			if (newPostalCode != null)
				msgs = ((InternalEObject)newPostalCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__POSTAL_CODE, null, msgs);
			msgs = basicSetPostalCode(newPostalCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__POSTAL_CODE, newPostalCode, newPostalCode));
	}
	...
	public NotificationChain basicSetPremise(PremiseType newPremise, NotificationChain msgs) {
		...
		premise = newPremise;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE, oldPremise, newPremise);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPremise(PremiseType newPremise) {
		if (newPremise != premise) {
			NotificationChain msgs = null;
			if (premise != null)
				msgs = ((InternalEObject)premise).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE, null, msgs);
			if (newPremise != null)
				msgs = ((InternalEObject)newPremise).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_TYPE__PREMISE, null, msgs);
			msgs = basicSetPremise(newPremise, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE, newPremise, newPremise));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _0Package.PREMISE_TYPE__ANY);
		}
		return any;
	}
	...
	public void setPremiseDependency(Object newPremiseDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_DEPENDENCY, oldPremiseDependency, premiseDependency));
	}
	...
	public void setPremiseDependencyType(Object newPremiseDependencyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_DEPENDENCY_TYPE, oldPremiseDependencyType, premiseDependencyType));
	}
	...
	public void setPremiseThoroughfareConnector(Object newPremiseThoroughfareConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__PREMISE_THOROUGHFARE_CONNECTOR, oldPremiseThoroughfareConnector, premiseThoroughfareConnector));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_TYPE__TYPE, oldType, type));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.PREMISE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.PREMISE_TYPE__PREMISE_DEPENDENCY:
				return getPremiseDependency();
			case _0Package.PREMISE_TYPE__PREMISE_DEPENDENCY_TYPE:
				return getPremiseDependencyType();
			case _0Package.PREMISE_TYPE__PREMISE_THOROUGHFARE_CONNECTOR:
				return getPremiseThoroughfareConnector();
			case _0Package.PREMISE_TYPE__TYPE:
				return getType();
			case _0Package.PREMISE_TYPE__ANY_ATTRIBUTE:
