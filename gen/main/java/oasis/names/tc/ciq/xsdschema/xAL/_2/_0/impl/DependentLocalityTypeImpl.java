...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.DependentLocalityNameType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.DependentLocalityNumberType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.DependentLocalityType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.LargeMailUserType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getDependentLocalityName <em>Dependent Locality Name</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getDependentLocalityNumber <em>Dependent Locality Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getPostBox <em>Post Box</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getLargeMailUser <em>Large Mail User</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getPostOffice <em>Post Office</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getPostalRoute <em>Postal Route</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getThoroughfare <em>Thoroughfare</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getPremise <em>Premise</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getDependentLocality <em>Dependent Locality</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getUsageType <em>Usage Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependentLocalityTypeImpl extends MinimalEObjectImpl.Container implements DependentLocalityType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getDependentLocalityType();
	}
	...
	public EList<AddressLineType> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLineType>(AddressLineType.class, this, _0Package.DEPENDENT_LOCALITY_TYPE__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public EList<DependentLocalityNameType> getDependentLocalityName() {
		if (dependentLocalityName == null) {
			dependentLocalityName = new EObjectContainmentEList<DependentLocalityNameType>(DependentLocalityNameType.class, this, _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NAME);
		}
	...
	public NotificationChain basicSetDependentLocalityNumber(DependentLocalityNumberType newDependentLocalityNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NUMBER, oldDependentLocalityNumber, newDependentLocalityNumber);
	...
	public void setDependentLocalityNumber(DependentLocalityNumberType newDependentLocalityNumber) {
		if (newDependentLocalityNumber != dependentLocalityNumber) {
			...
			if (dependentLocalityNumber != null)
				msgs = ((InternalEObject)dependentLocalityNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NUMBER, null, msgs);
			if (newDependentLocalityNumber != null)
				msgs = ((InternalEObject)newDependentLocalityNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NUMBER, null, msgs);
			msgs = basicSetDependentLocalityNumber(newDependentLocalityNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NUMBER, newDependentLocalityNumber, newDependentLocalityNumber));
	}
	...
	public NotificationChain basicSetPostBox(PostBoxType newPostBox, NotificationChain msgs) {
		...
		postBox = newPostBox;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POST_BOX, oldPostBox, newPostBox);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostBox(PostBoxType newPostBox) {
		if (newPostBox != postBox) {
			NotificationChain msgs = null;
			if (postBox != null)
				msgs = ((InternalEObject)postBox).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POST_BOX, null, msgs);
			if (newPostBox != null)
				msgs = ((InternalEObject)newPostBox).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POST_BOX, null, msgs);
			msgs = basicSetPostBox(newPostBox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POST_BOX, newPostBox, newPostBox));
	}
	...
	public NotificationChain basicSetLargeMailUser(LargeMailUserType newLargeMailUser, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__LARGE_MAIL_USER, oldLargeMailUser, newLargeMailUser);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLargeMailUser(LargeMailUserType newLargeMailUser) {
		if (newLargeMailUser != largeMailUser) {
			...
			if (largeMailUser != null)
				msgs = ((InternalEObject)largeMailUser).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__LARGE_MAIL_USER, null, msgs);
			if (newLargeMailUser != null)
				msgs = ((InternalEObject)newLargeMailUser).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__LARGE_MAIL_USER, null, msgs);
			msgs = basicSetLargeMailUser(newLargeMailUser, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__LARGE_MAIL_USER, newLargeMailUser, newLargeMailUser));
	}
	...
	public NotificationChain basicSetPostOffice(PostOfficeType newPostOffice, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POST_OFFICE, oldPostOffice, newPostOffice);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostOffice(PostOfficeType newPostOffice) {
		if (newPostOffice != postOffice) {
			NotificationChain msgs = null;
			if (postOffice != null)
				msgs = ((InternalEObject)postOffice).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POST_OFFICE, null, msgs);
			if (newPostOffice != null)
				msgs = ((InternalEObject)newPostOffice).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POST_OFFICE, null, msgs);
			msgs = basicSetPostOffice(newPostOffice, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POST_OFFICE, newPostOffice, newPostOffice));
	}
	...
	public NotificationChain basicSetPostalRoute(PostalRouteType newPostalRoute, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_ROUTE, oldPostalRoute, newPostalRoute);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostalRoute(PostalRouteType newPostalRoute) {
		if (newPostalRoute != postalRoute) {
			NotificationChain msgs = null;
			if (postalRoute != null)
				msgs = ((InternalEObject)postalRoute).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_ROUTE, null, msgs);
			if (newPostalRoute != null)
				msgs = ((InternalEObject)newPostalRoute).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_ROUTE, null, msgs);
			msgs = basicSetPostalRoute(newPostalRoute, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_ROUTE, newPostalRoute, newPostalRoute));
	}
	...
	public NotificationChain basicSetThoroughfare(ThoroughfareType newThoroughfare, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__THOROUGHFARE, oldThoroughfare, newThoroughfare);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThoroughfare(ThoroughfareType newThoroughfare) {
		if (newThoroughfare != thoroughfare) {
			...
			if (thoroughfare != null)
				msgs = ((InternalEObject)thoroughfare).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__THOROUGHFARE, null, msgs);
			if (newThoroughfare != null)
				msgs = ((InternalEObject)newThoroughfare).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__THOROUGHFARE, null, msgs);
			msgs = basicSetThoroughfare(newThoroughfare, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__THOROUGHFARE, newThoroughfare, newThoroughfare));
	}
	...
	public NotificationChain basicSetPremise(PremiseType newPremise, NotificationChain msgs) {
		...
		premise = newPremise;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__PREMISE, oldPremise, newPremise);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPremise(PremiseType newPremise) {
		if (newPremise != premise) {
			NotificationChain msgs = null;
			if (premise != null)
				msgs = ((InternalEObject)premise).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__PREMISE, null, msgs);
			if (newPremise != null)
				msgs = ((InternalEObject)newPremise).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__PREMISE, null, msgs);
			msgs = basicSetPremise(newPremise, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__PREMISE, newPremise, newPremise));
	}
	...
	public NotificationChain basicSetDependentLocality(DependentLocalityType newDependentLocality, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY, oldDependentLocality, newDependentLocality);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDependentLocality(DependentLocalityType newDependentLocality) {
		if (newDependentLocality != dependentLocality) {
			...
			if (dependentLocality != null)
				msgs = ((InternalEObject)dependentLocality).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY, null, msgs);
			if (newDependentLocality != null)
				msgs = ((InternalEObject)newDependentLocality).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY, null, msgs);
			msgs = basicSetDependentLocality(newDependentLocality, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY, newDependentLocality, newDependentLocality));
	}
	...
	public NotificationChain basicSetPostalCode(PostalCodeType newPostalCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_CODE, oldPostalCode, newPostalCode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostalCode(PostalCodeType newPostalCode) {
		if (newPostalCode != postalCode) {
			NotificationChain msgs = null;
			if (postalCode != null)
				msgs = ((InternalEObject)postalCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_CODE, null, msgs);
			if (newPostalCode != null)
				msgs = ((InternalEObject)newPostalCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_CODE, null, msgs);
			msgs = basicSetPostalCode(newPostalCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_CODE, newPostalCode, newPostalCode));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _0Package.DEPENDENT_LOCALITY_TYPE__ANY);
		}
		return any;
	}
	...
	public void setConnector(Object newConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__CONNECTOR, oldConnector, connector));
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__TYPE, oldType, type));
	}
	...
	public void setUsageType(Object newUsageType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_TYPE__USAGE_TYPE, oldUsageType, usageType));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.DEPENDENT_LOCALITY_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.DEPENDENT_LOCALITY_TYPE__ADDRESS_LINE:
				return ((InternalEList<?>)getAddressLine()).basicRemove(otherEnd, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NAME:
				return ((InternalEList<?>)getDependentLocalityName()).basicRemove(otherEnd, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY_NUMBER:
				return basicSetDependentLocalityNumber(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__POST_BOX:
				return basicSetPostBox(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__LARGE_MAIL_USER:
				return basicSetLargeMailUser(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__POST_OFFICE:
				return basicSetPostOffice(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_ROUTE:
				return basicSetPostalRoute(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__THOROUGHFARE:
				return basicSetThoroughfare(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__PREMISE:
				return basicSetPremise(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__DEPENDENT_LOCALITY:
				return basicSetDependentLocality(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__POSTAL_CODE:
				return basicSetPostalCode(null, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case _0Package.DEPENDENT_LOCALITY_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.DEPENDENT_LOCALITY_TYPE__CONNECTOR:
				return getConnector();
			case _0Package.DEPENDENT_LOCALITY_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.DEPENDENT_LOCALITY_TYPE__TYPE:
				return getType();
			case _0Package.DEPENDENT_LOCALITY_TYPE__USAGE_TYPE:
				return getUsageType();
			case _0Package.DEPENDENT_LOCALITY_TYPE__ANY_ATTRIBUTE:
