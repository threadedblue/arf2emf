 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxNumberPrefixTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxNumberPrefixTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxNumberPrefixTypeImpl#getNumberPrefixSeparator <em>Number Prefix Separator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxNumberPrefixTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostBoxNumberPrefixTypeImpl extends MinimalEObjectImpl.Container implements PostBoxNumberPrefixType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPostBoxNumberPrefixType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, _0Package.POST_BOX_NUMBER_PREFIX_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setCode(Object newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_NUMBER_PREFIX_TYPE__CODE, oldCode, code));
	}
	...
	public void setNumberPrefixSeparator(Object newNumberPrefixSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_NUMBER_PREFIX_TYPE__NUMBER_PREFIX_SEPARATOR, oldNumberPrefixSeparator, numberPrefixSeparator));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.POST_BOX_NUMBER_PREFIX_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.POST_BOX_NUMBER_PREFIX_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case _0Package.POST_BOX_NUMBER_PREFIX_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.POST_BOX_NUMBER_PREFIX_TYPE__CODE:
				return getCode();
			case _0Package.POST_BOX_NUMBER_PREFIX_TYPE__NUMBER_PREFIX_SEPARATOR:
