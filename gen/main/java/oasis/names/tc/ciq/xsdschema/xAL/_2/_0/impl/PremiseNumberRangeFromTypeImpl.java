 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeFromTypeImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeFromTypeImpl#getPremiseNumberPrefix <em>Premise Number Prefix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeFromTypeImpl#getPremiseNumber <em>Premise Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeFromTypeImpl#getPremiseNumberSuffix <em>Premise Number Suffix</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PremiseNumberRangeFromTypeImpl extends MinimalEObjectImpl.Container implements PremiseNumberRangeFromType {
	/**
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPremiseNumberRangeFromType();
	}
	...
	public EList<AddressLineType> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLineType>(AddressLineType.class, this, _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public EList<PremiseNumberPrefixType> getPremiseNumberPrefix() {
		if (premiseNumberPrefix == null) {
			premiseNumberPrefix = new EObjectContainmentEList<PremiseNumberPrefixType>(PremiseNumberPrefixType.class, this, _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER_PREFIX);
		}
	...
	public EList<PremiseNumberType> getPremiseNumber() {
		if (premiseNumber == null) {
			premiseNumber = new EObjectContainmentEList<PremiseNumberType>(PremiseNumberType.class, this, _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER);
		}
	...
	public EList<PremiseNumberSuffixType> getPremiseNumberSuffix() {
		if (premiseNumberSuffix == null) {
			premiseNumberSuffix = new EObjectContainmentEList<PremiseNumberSuffixType>(PremiseNumberSuffixType.class, this, _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER_SUFFIX);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__ADDRESS_LINE:
				return ((InternalEList<?>)getAddressLine()).basicRemove(otherEnd, msgs);
			case _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER_PREFIX:
				return ((InternalEList<?>)getPremiseNumberPrefix()).basicRemove(otherEnd, msgs);
			case _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER:
				return ((InternalEList<?>)getPremiseNumber()).basicRemove(otherEnd, msgs);
			case _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE__PREMISE_NUMBER_SUFFIX:
