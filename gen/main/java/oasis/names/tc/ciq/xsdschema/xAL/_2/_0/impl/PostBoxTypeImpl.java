...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PostBoxNumberPrefixType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PostBoxNumberSuffixType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PostBoxNumberType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getPostBoxNumber <em>Post Box Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getPostBoxNumberPrefix <em>Post Box Number Prefix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getPostBoxNumberSuffix <em>Post Box Number Suffix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getPostBoxNumberExtension <em>Post Box Number Extension</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getFirm <em>Firm</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostBoxTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostBoxTypeImpl extends MinimalEObjectImpl.Container implements PostBoxType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPostBoxType();
	}
	...
	public EList<AddressLineType> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLineType>(AddressLineType.class, this, _0Package.POST_BOX_TYPE__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public NotificationChain basicSetPostBoxNumber(PostBoxNumberType newPostBoxNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER, oldPostBoxNumber, newPostBoxNumber);
	...
	public void setPostBoxNumber(PostBoxNumberType newPostBoxNumber) {
		if (newPostBoxNumber != postBoxNumber) {
			...
			if (postBoxNumber != null)
				msgs = ((InternalEObject)postBoxNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER, null, msgs);
			if (newPostBoxNumber != null)
				msgs = ((InternalEObject)newPostBoxNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER, null, msgs);
			msgs = basicSetPostBoxNumber(newPostBoxNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER, newPostBoxNumber, newPostBoxNumber));
	}
	...
	public NotificationChain basicSetPostBoxNumberPrefix(PostBoxNumberPrefixType newPostBoxNumberPrefix, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_PREFIX, oldPostBoxNumberPrefix, newPostBoxNumberPrefix);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostBoxNumberPrefix(PostBoxNumberPrefixType newPostBoxNumberPrefix) {
		if (newPostBoxNumberPrefix != postBoxNumberPrefix) {
			...
			if (postBoxNumberPrefix != null)
				msgs = ((InternalEObject)postBoxNumberPrefix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_PREFIX, null, msgs);
			if (newPostBoxNumberPrefix != null)
				msgs = ((InternalEObject)newPostBoxNumberPrefix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_PREFIX, null, msgs);
			msgs = basicSetPostBoxNumberPrefix(newPostBoxNumberPrefix, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_PREFIX, newPostBoxNumberPrefix, newPostBoxNumberPrefix));
	}
	...
	public NotificationChain basicSetPostBoxNumberSuffix(PostBoxNumberSuffixType newPostBoxNumberSuffix, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_SUFFIX, oldPostBoxNumberSuffix, newPostBoxNumberSuffix);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostBoxNumberSuffix(PostBoxNumberSuffixType newPostBoxNumberSuffix) {
		if (newPostBoxNumberSuffix != postBoxNumberSuffix) {
			...
			if (postBoxNumberSuffix != null)
				msgs = ((InternalEObject)postBoxNumberSuffix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_SUFFIX, null, msgs);
			if (newPostBoxNumberSuffix != null)
				msgs = ((InternalEObject)newPostBoxNumberSuffix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_SUFFIX, null, msgs);
			msgs = basicSetPostBoxNumberSuffix(newPostBoxNumberSuffix, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_SUFFIX, newPostBoxNumberSuffix, newPostBoxNumberSuffix));
	}
	...
	public NotificationChain basicSetPostBoxNumberExtension(PostBoxNumberExtensionType newPostBoxNumberExtension, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_EXTENSION, oldPostBoxNumberExtension, newPostBoxNumberExtension);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostBoxNumberExtension(PostBoxNumberExtensionType newPostBoxNumberExtension) {
		if (newPostBoxNumberExtension != postBoxNumberExtension) {
			...
			if (postBoxNumberExtension != null)
				msgs = ((InternalEObject)postBoxNumberExtension).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_EXTENSION, null, msgs);
			if (newPostBoxNumberExtension != null)
				msgs = ((InternalEObject)newPostBoxNumberExtension).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_EXTENSION, null, msgs);
			msgs = basicSetPostBoxNumberExtension(newPostBoxNumberExtension, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_EXTENSION, newPostBoxNumberExtension, newPostBoxNumberExtension));
	}
	...
	public NotificationChain basicSetFirm(FirmType newFirm, NotificationChain msgs) {
		...
		firm = newFirm;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__FIRM, oldFirm, newFirm);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFirm(FirmType newFirm) {
		if (newFirm != firm) {
			NotificationChain msgs = null;
			if (firm != null)
				msgs = ((InternalEObject)firm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__FIRM, null, msgs);
			if (newFirm != null)
				msgs = ((InternalEObject)newFirm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__FIRM, null, msgs);
			msgs = basicSetFirm(newFirm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__FIRM, newFirm, newFirm));
	}
	...
	public NotificationChain basicSetPostalCode(PostalCodeType newPostalCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POSTAL_CODE, oldPostalCode, newPostalCode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostalCode(PostalCodeType newPostalCode) {
		if (newPostalCode != postalCode) {
			NotificationChain msgs = null;
			if (postalCode != null)
				msgs = ((InternalEObject)postalCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POSTAL_CODE, null, msgs);
			if (newPostalCode != null)
				msgs = ((InternalEObject)newPostalCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.POST_BOX_TYPE__POSTAL_CODE, null, msgs);
			msgs = basicSetPostalCode(newPostalCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__POSTAL_CODE, newPostalCode, newPostalCode));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _0Package.POST_BOX_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_BOX_TYPE__TYPE, oldType, type));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.POST_BOX_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.POST_BOX_TYPE__ADDRESS_LINE:
				return ((InternalEList<?>)getAddressLine()).basicRemove(otherEnd, msgs);
			case _0Package.POST_BOX_TYPE__POST_BOX_NUMBER:
				return basicSetPostBoxNumber(null, msgs);
			case _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_PREFIX:
				return basicSetPostBoxNumberPrefix(null, msgs);
			case _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_SUFFIX:
				return basicSetPostBoxNumberSuffix(null, msgs);
			case _0Package.POST_BOX_TYPE__POST_BOX_NUMBER_EXTENSION:
				return basicSetPostBoxNumberExtension(null, msgs);
			case _0Package.POST_BOX_TYPE__FIRM:
				return basicSetFirm(null, msgs);
			case _0Package.POST_BOX_TYPE__POSTAL_CODE:
				return basicSetPostalCode(null, msgs);
			case _0Package.POST_BOX_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case _0Package.POST_BOX_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.POST_BOX_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.POST_BOX_TYPE__TYPE:
				return getType();
			case _0Package.POST_BOX_TYPE__ANY_ATTRIBUTE:
