...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.IndicatorOccurrenceType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostOfficeNumberTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostOfficeNumberTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostOfficeNumberTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostOfficeNumberTypeImpl#getIndicatorOccurrence <em>Indicator Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PostOfficeNumberTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostOfficeNumberTypeImpl extends MinimalEObjectImpl.Container implements PostOfficeNumberType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPostOfficeNumberType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, _0Package.POST_OFFICE_NUMBER_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setCode(Object newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_OFFICE_NUMBER_TYPE__CODE, oldCode, code));
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_OFFICE_NUMBER_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setIndicatorOccurrence(IndicatorOccurrenceType newIndicatorOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.POST_OFFICE_NUMBER_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, indicatorOccurrence, !oldIndicatorOccurrenceESet));
	}
	...
	public void unsetIndicatorOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.POST_OFFICE_NUMBER_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, INDICATOR_OCCURRENCE_EDEFAULT, oldIndicatorOccurrenceESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.POST_OFFICE_NUMBER_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.POST_OFFICE_NUMBER_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case _0Package.POST_OFFICE_NUMBER_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.POST_OFFICE_NUMBER_TYPE__CODE:
				return getCode();
			case _0Package.POST_OFFICE_NUMBER_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.POST_OFFICE_NUMBER_TYPE__INDICATOR_OCCURRENCE:
