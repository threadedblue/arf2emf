...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.IndicatorOccurrenceType1;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.NumberRangeOccurrenceType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.RangeTypeType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.ThoroughfareNumberFromType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getThoroughfareNumberFrom <em>Thoroughfare Number From</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getThoroughfareNumberTo <em>Thoroughfare Number To</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getIndicatorOccurrence <em>Indicator Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getNumberRangeOccurrence <em>Number Range Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getSeparator <em>Separator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberRangeTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThoroughfareNumberRangeTypeImpl extends MinimalEObjectImpl.Container implements ThoroughfareNumberRangeType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getThoroughfareNumberRangeType();
	}
	...
	public EList<AddressLineType> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLineType>(AddressLineType.class, this, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public NotificationChain basicSetThoroughfareNumberFrom(ThoroughfareNumberFromType newThoroughfareNumberFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_FROM, oldThoroughfareNumberFrom, newThoroughfareNumberFrom);
	...
	public void setThoroughfareNumberFrom(ThoroughfareNumberFromType newThoroughfareNumberFrom) {
		if (newThoroughfareNumberFrom != thoroughfareNumberFrom) {
			...
			if (thoroughfareNumberFrom != null)
				msgs = ((InternalEObject)thoroughfareNumberFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_FROM, null, msgs);
			if (newThoroughfareNumberFrom != null)
				msgs = ((InternalEObject)newThoroughfareNumberFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_FROM, null, msgs);
			msgs = basicSetThoroughfareNumberFrom(newThoroughfareNumberFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_FROM, newThoroughfareNumberFrom, newThoroughfareNumberFrom));
	}
	...
	public NotificationChain basicSetThoroughfareNumberTo(ThoroughfareNumberToType newThoroughfareNumberTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_TO, oldThoroughfareNumberTo, newThoroughfareNumberTo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThoroughfareNumberTo(ThoroughfareNumberToType newThoroughfareNumberTo) {
		if (newThoroughfareNumberTo != thoroughfareNumberTo) {
			...
			if (thoroughfareNumberTo != null)
				msgs = ((InternalEObject)thoroughfareNumberTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_TO, null, msgs);
			if (newThoroughfareNumberTo != null)
				msgs = ((InternalEObject)newThoroughfareNumberTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_TO, null, msgs);
			msgs = basicSetThoroughfareNumberTo(newThoroughfareNumberTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_TO, newThoroughfareNumberTo, newThoroughfareNumberTo));
	}
	...
	public void setCode(Object newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__CODE, oldCode, code));
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setIndicatorOccurrence(IndicatorOccurrenceType1 newIndicatorOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, indicatorOccurrence, !oldIndicatorOccurrenceESet));
	}
	...
	public void unsetIndicatorOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, INDICATOR_OCCURRENCE_EDEFAULT, oldIndicatorOccurrenceESet));
	}
	...
	public void setNumberRangeOccurrence(NumberRangeOccurrenceType newNumberRangeOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURRENCE, oldNumberRangeOccurrence, numberRangeOccurrence, !oldNumberRangeOccurrenceESet));
	}
	...
	public void unsetNumberRangeOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURRENCE, oldNumberRangeOccurrence, NUMBER_RANGE_OCCURRENCE_EDEFAULT, oldNumberRangeOccurrenceESet));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setSeparator(Object newSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__SEPARATOR, oldSeparator, separator));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__TYPE, oldType, type));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__ADDRESS_LINE:
				return ((InternalEList<?>)getAddressLine()).basicRemove(otherEnd, msgs);
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_FROM:
				return basicSetThoroughfareNumberFrom(null, msgs);
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__THOROUGHFARE_NUMBER_TO:
				return basicSetThoroughfareNumberTo(null, msgs);
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__CODE:
				return getCode();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__INDICATOR_OCCURRENCE:
				return getIndicatorOccurrence();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURRENCE:
				return getNumberRangeOccurrence();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__RANGE_TYPE:
				return getRangeType();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__SEPARATOR:
				return getSeparator();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__TYPE:
				return getType();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE__ANY_ATTRIBUTE:
