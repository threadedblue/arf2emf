...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Number Occurrence Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see oasis.names.tc.ciq.xsdschema.xAL._2._0._0Package#getNumberOccurrenceType()
 * @model extendedMetaData="name='NumberOccurrence_._type'"
 * @generated
 */
public enum NumberOccurrenceType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Number Occurrence Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NumberOccurrenceType[] VALUES_ARRAY =
		new NumberOccurrenceType[] {
			BEFORE_NAME,
			AFTER_NAME,
			BEFORE_TYPE,
			AFTER_TYPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Number Occurrence Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NumberOccurrenceType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Number Occurrence Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NumberOccurrenceType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberOccurrenceType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Occurrence Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static NumberOccurrenceType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberOccurrenceType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Occurrence Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NumberOccurrenceType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NumberOccurrenceType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
