...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.AddressLinesType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.AddressType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getPostalServiceElements <em>Postal Service Elements</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAddressLines <em>Address Lines</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAdministrativeArea <em>Administrative Area</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getLocality <em>Locality</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getThoroughfare <em>Thoroughfare</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAddressDetailsKey <em>Address Details Key</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAddressType <em>Address Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getCurrentStatus <em>Current Status</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getValidFromDate <em>Valid From Date</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getValidToDate <em>Valid To Date</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.AddressDetailsImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressDetailsImpl extends MinimalEObjectImpl.Container implements AddressDetails {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getAddressDetails();
	}
	...
	public NotificationChain basicSetPostalServiceElements(PostalServiceElementsType newPostalServiceElements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__POSTAL_SERVICE_ELEMENTS, oldPostalServiceElements, newPostalServiceElements);
	...
	public void setPostalServiceElements(PostalServiceElementsType newPostalServiceElements) {
		if (newPostalServiceElements != postalServiceElements) {
			...
			if (postalServiceElements != null)
				msgs = ((InternalEObject)postalServiceElements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__POSTAL_SERVICE_ELEMENTS, null, msgs);
			if (newPostalServiceElements != null)
				msgs = ((InternalEObject)newPostalServiceElements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__POSTAL_SERVICE_ELEMENTS, null, msgs);
			msgs = basicSetPostalServiceElements(newPostalServiceElements, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__POSTAL_SERVICE_ELEMENTS, newPostalServiceElements, newPostalServiceElements));
	}
	...
	public NotificationChain basicSetAddress(AddressType newAddress, NotificationChain msgs) {
		...
		address = newAddress;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS, oldAddress, newAddress);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddress(AddressType newAddress) {
		if (newAddress != address) {
			NotificationChain msgs = null;
			if (address != null)
				msgs = ((InternalEObject)address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADDRESS, null, msgs);
			if (newAddress != null)
				msgs = ((InternalEObject)newAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADDRESS, null, msgs);
			msgs = basicSetAddress(newAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS, newAddress, newAddress));
	}
	...
	public NotificationChain basicSetAddressLines(AddressLinesType newAddressLines, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS_LINES, oldAddressLines, newAddressLines);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddressLines(AddressLinesType newAddressLines) {
		if (newAddressLines != addressLines) {
			...
			if (addressLines != null)
				msgs = ((InternalEObject)addressLines).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADDRESS_LINES, null, msgs);
			if (newAddressLines != null)
				msgs = ((InternalEObject)newAddressLines).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADDRESS_LINES, null, msgs);
			msgs = basicSetAddressLines(newAddressLines, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS_LINES, newAddressLines, newAddressLines));
	}
	...
	public NotificationChain basicSetCountry(CountryType newCountry, NotificationChain msgs) {
		...
		country = newCountry;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__COUNTRY, oldCountry, newCountry);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCountry(CountryType newCountry) {
		if (newCountry != country) {
			NotificationChain msgs = null;
			if (country != null)
				msgs = ((InternalEObject)country).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__COUNTRY, null, msgs);
			if (newCountry != null)
				msgs = ((InternalEObject)newCountry).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__COUNTRY, null, msgs);
			msgs = basicSetCountry(newCountry, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__COUNTRY, newCountry, newCountry));
	}
	...
	public NotificationChain basicSetAdministrativeArea(AdministrativeAreaType newAdministrativeArea, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADMINISTRATIVE_AREA, oldAdministrativeArea, newAdministrativeArea);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdministrativeArea(AdministrativeAreaType newAdministrativeArea) {
		if (newAdministrativeArea != administrativeArea) {
			...
			if (administrativeArea != null)
				msgs = ((InternalEObject)administrativeArea).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADMINISTRATIVE_AREA, null, msgs);
			if (newAdministrativeArea != null)
				msgs = ((InternalEObject)newAdministrativeArea).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__ADMINISTRATIVE_AREA, null, msgs);
			msgs = basicSetAdministrativeArea(newAdministrativeArea, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADMINISTRATIVE_AREA, newAdministrativeArea, newAdministrativeArea));
	}
	...
	public NotificationChain basicSetLocality(LocalityType newLocality, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__LOCALITY, oldLocality, newLocality);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLocality(LocalityType newLocality) {
		if (newLocality != locality) {
			NotificationChain msgs = null;
			if (locality != null)
				msgs = ((InternalEObject)locality).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__LOCALITY, null, msgs);
			if (newLocality != null)
				msgs = ((InternalEObject)newLocality).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__LOCALITY, null, msgs);
			msgs = basicSetLocality(newLocality, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__LOCALITY, newLocality, newLocality));
	}
	...
	public NotificationChain basicSetThoroughfare(ThoroughfareType newThoroughfare, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__THOROUGHFARE, oldThoroughfare, newThoroughfare);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThoroughfare(ThoroughfareType newThoroughfare) {
		if (newThoroughfare != thoroughfare) {
			...
			if (thoroughfare != null)
				msgs = ((InternalEObject)thoroughfare).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__THOROUGHFARE, null, msgs);
			if (newThoroughfare != null)
				msgs = ((InternalEObject)newThoroughfare).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.ADDRESS_DETAILS__THOROUGHFARE, null, msgs);
			msgs = basicSetThoroughfare(newThoroughfare, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__THOROUGHFARE, newThoroughfare, newThoroughfare));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _0Package.ADDRESS_DETAILS__ANY);
		}
		return any;
	}
	...
	public void setAddressDetailsKey(Object newAddressDetailsKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS_DETAILS_KEY, oldAddressDetailsKey, addressDetailsKey));
	}
	...
	public void setAddressType(Object newAddressType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__ADDRESS_TYPE, oldAddressType, addressType));
	}
	...
	public void setCode(Object newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__CODE, oldCode, code));
	}
	...
	public void setCurrentStatus(Object newCurrentStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__CURRENT_STATUS, oldCurrentStatus, currentStatus));
	}
	...
	public void setUsage(Object newUsage) {
		...
		usage = newUsage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__USAGE, oldUsage, usage));
	}
	...
	public void setValidFromDate(Object newValidFromDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__VALID_FROM_DATE, oldValidFromDate, validFromDate));
	}
	...
	public void setValidToDate(Object newValidToDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ADDRESS_DETAILS__VALID_TO_DATE, oldValidToDate, validToDate));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.ADDRESS_DETAILS__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.ADDRESS_DETAILS__POSTAL_SERVICE_ELEMENTS:
				return basicSetPostalServiceElements(null, msgs);
			case _0Package.ADDRESS_DETAILS__ADDRESS:
				return basicSetAddress(null, msgs);
			case _0Package.ADDRESS_DETAILS__ADDRESS_LINES:
				return basicSetAddressLines(null, msgs);
			case _0Package.ADDRESS_DETAILS__COUNTRY:
				return basicSetCountry(null, msgs);
			case _0Package.ADDRESS_DETAILS__ADMINISTRATIVE_AREA:
				return basicSetAdministrativeArea(null, msgs);
			case _0Package.ADDRESS_DETAILS__LOCALITY:
				return basicSetLocality(null, msgs);
			case _0Package.ADDRESS_DETAILS__THOROUGHFARE:
				return basicSetThoroughfare(null, msgs);
			case _0Package.ADDRESS_DETAILS__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case _0Package.ADDRESS_DETAILS__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.ADDRESS_DETAILS__ADDRESS_DETAILS_KEY:
				return getAddressDetailsKey();
			case _0Package.ADDRESS_DETAILS__ADDRESS_TYPE:
				return getAddressType();
			case _0Package.ADDRESS_DETAILS__CODE:
				return getCode();
			case _0Package.ADDRESS_DETAILS__CURRENT_STATUS:
				return getCurrentStatus();
			case _0Package.ADDRESS_DETAILS__USAGE:
				return getUsage();
			case _0Package.ADDRESS_DETAILS__VALID_FROM_DATE:
				return getValidFromDate();
			case _0Package.ADDRESS_DETAILS__VALID_TO_DATE:
