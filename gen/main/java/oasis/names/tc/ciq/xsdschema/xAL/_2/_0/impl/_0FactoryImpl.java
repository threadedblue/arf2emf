...
public class _0FactoryImpl extends EFactoryImpl implements _0Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case _0Package.ADDRESS_DETAILS: return createAddressDetails();
			case _0Package.ADDRESS_IDENTIFIER_TYPE: return createAddressIdentifierType();
			case _0Package.ADDRESS_LATITUDE_DIRECTION_TYPE: return createAddressLatitudeDirectionType();
			case _0Package.ADDRESS_LATITUDE_TYPE: return createAddressLatitudeType();
			case _0Package.ADDRESS_LINES_TYPE: return createAddressLinesType();
			case _0Package.ADDRESS_LINE_TYPE: return createAddressLineType();
			case _0Package.ADDRESS_LONGITUDE_DIRECTION_TYPE: return createAddressLongitudeDirectionType();
			case _0Package.ADDRESS_LONGITUDE_TYPE: return createAddressLongitudeType();
			case _0Package.ADDRESS_TYPE: return createAddressType();
			case _0Package.ADMINISTRATIVE_AREA_NAME_TYPE: return createAdministrativeAreaNameType();
			case _0Package.ADMINISTRATIVE_AREA_TYPE: return createAdministrativeAreaType();
			case _0Package.BARCODE_TYPE: return createBarcodeType();
			case _0Package.BUILDING_NAME_TYPE: return createBuildingNameType();
			case _0Package.COUNTRY_NAME_CODE_TYPE: return createCountryNameCodeType();
			case _0Package.COUNTRY_NAME_TYPE: return createCountryNameType();
			case _0Package.COUNTRY_TYPE: return createCountryType();
			case _0Package.DEPARTMENT_NAME_TYPE: return createDepartmentNameType();
			case _0Package.DEPARTMENT_TYPE: return createDepartmentType();
			case _0Package.DEPENDENT_LOCALITY_NAME_TYPE: return createDependentLocalityNameType();
			case _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE: return createDependentLocalityNumberType();
			case _0Package.DEPENDENT_LOCALITY_TYPE: return createDependentLocalityType();
			case _0Package.DEPENDENT_THOROUGHFARE_TYPE: return createDependentThoroughfareType();
			case _0Package.DOCUMENT_ROOT: return createDocumentRoot();
			case _0Package.ENDORSEMENT_LINE_CODE_TYPE: return createEndorsementLineCodeType();
			case _0Package.FIRM_NAME_TYPE: return createFirmNameType();
			case _0Package.FIRM_TYPE: return createFirmType();
			case _0Package.KEY_LINE_CODE_TYPE: return createKeyLineCodeType();
			case _0Package.LARGE_MAIL_USER_IDENTIFIER_TYPE: return createLargeMailUserIdentifierType();
			case _0Package.LARGE_MAIL_USER_NAME_TYPE: return createLargeMailUserNameType();
			case _0Package.LARGE_MAIL_USER_TYPE: return createLargeMailUserType();
			case _0Package.LOCALITY_NAME_TYPE: return createLocalityNameType();
			case _0Package.LOCALITY_TYPE: return createLocalityType();
			case _0Package.MAIL_STOP_NAME_TYPE: return createMailStopNameType();
			case _0Package.MAIL_STOP_NUMBER_TYPE: return createMailStopNumberType();
			case _0Package.MAIL_STOP_TYPE: return createMailStopType();
			case _0Package.POSTAL_CODE_NUMBER_EXTENSION_TYPE: return createPostalCodeNumberExtensionType();
			case _0Package.POSTAL_CODE_NUMBER_TYPE: return createPostalCodeNumberType();
			case _0Package.POSTAL_CODE_TYPE: return createPostalCodeType();
			case _0Package.POSTAL_ROUTE_NAME_TYPE: return createPostalRouteNameType();
			case _0Package.POSTAL_ROUTE_NUMBER_TYPE: return createPostalRouteNumberType();
			case _0Package.POSTAL_ROUTE_TYPE: return createPostalRouteType();
			case _0Package.POSTAL_SERVICE_ELEMENTS_TYPE: return createPostalServiceElementsType();
			case _0Package.POST_BOX_NUMBER_EXTENSION_TYPE: return createPostBoxNumberExtensionType();
			case _0Package.POST_BOX_NUMBER_PREFIX_TYPE: return createPostBoxNumberPrefixType();
			case _0Package.POST_BOX_NUMBER_SUFFIX_TYPE: return createPostBoxNumberSuffixType();
			case _0Package.POST_BOX_NUMBER_TYPE: return createPostBoxNumberType();
			case _0Package.POST_BOX_TYPE: return createPostBoxType();
			case _0Package.POST_OFFICE_NAME_TYPE: return createPostOfficeNameType();
			case _0Package.POST_OFFICE_NUMBER_TYPE: return createPostOfficeNumberType();
			case _0Package.POST_OFFICE_TYPE: return createPostOfficeType();
			case _0Package.POST_TOWN_NAME_TYPE: return createPostTownNameType();
			case _0Package.POST_TOWN_SUFFIX_TYPE: return createPostTownSuffixType();
			case _0Package.POST_TOWN_TYPE: return createPostTownType();
			case _0Package.PREMISE_LOCATION_TYPE: return createPremiseLocationType();
			case _0Package.PREMISE_NAME_TYPE: return createPremiseNameType();
			case _0Package.PREMISE_NUMBER_PREFIX_TYPE: return createPremiseNumberPrefixType();
			case _0Package.PREMISE_NUMBER_RANGE_FROM_TYPE: return createPremiseNumberRangeFromType();
			case _0Package.PREMISE_NUMBER_RANGE_TO_TYPE: return createPremiseNumberRangeToType();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE: return createPremiseNumberRangeType();
			case _0Package.PREMISE_NUMBER_SUFFIX_TYPE: return createPremiseNumberSuffixType();
			case _0Package.PREMISE_NUMBER_TYPE: return createPremiseNumberType();
			case _0Package.PREMISE_TYPE: return createPremiseType();
			case _0Package.SORTING_CODE_TYPE: return createSortingCodeType();
			case _0Package.SUB_ADMINISTRATIVE_AREA_NAME_TYPE: return createSubAdministrativeAreaNameType();
			case _0Package.SUB_ADMINISTRATIVE_AREA_TYPE: return createSubAdministrativeAreaType();
			case _0Package.SUB_PREMISE_LOCATION_TYPE: return createSubPremiseLocationType();
			case _0Package.SUB_PREMISE_NAME_TYPE: return createSubPremiseNameType();
			case _0Package.SUB_PREMISE_NUMBER_PREFIX_TYPE: return createSubPremiseNumberPrefixType();
			case _0Package.SUB_PREMISE_NUMBER_SUFFIX_TYPE: return createSubPremiseNumberSuffixType();
			case _0Package.SUB_PREMISE_NUMBER_TYPE: return createSubPremiseNumberType();
			case _0Package.SUB_PREMISE_TYPE: return createSubPremiseType();
			case _0Package.SUPPLEMENTARY_POSTAL_SERVICE_DATA_TYPE: return createSupplementaryPostalServiceDataType();
			case _0Package.THOROUGHFARE_LEADING_TYPE_TYPE: return createThoroughfareLeadingTypeType();
			case _0Package.THOROUGHFARE_NAME_TYPE: return createThoroughfareNameType();
			case _0Package.THOROUGHFARE_NUMBER_FROM_TYPE: return createThoroughfareNumberFromType();
			case _0Package.THOROUGHFARE_NUMBER_PREFIX_TYPE: return createThoroughfareNumberPrefixType();
			case _0Package.THOROUGHFARE_NUMBER_RANGE_TYPE: return createThoroughfareNumberRangeType();
			case _0Package.THOROUGHFARE_NUMBER_SUFFIX_TYPE: return createThoroughfareNumberSuffixType();
			case _0Package.THOROUGHFARE_NUMBER_TO_TYPE: return createThoroughfareNumberToType();
			case _0Package.THOROUGHFARE_NUMBER_TYPE: return createThoroughfareNumberType();
			case _0Package.THOROUGHFARE_POST_DIRECTION_TYPE: return createThoroughfarePostDirectionType();
			case _0Package.THOROUGHFARE_PRE_DIRECTION_TYPE: return createThoroughfarePreDirectionType();
			case _0Package.THOROUGHFARE_TRAILING_TYPE_TYPE: return createThoroughfareTrailingTypeType();
			case _0Package.THOROUGHFARE_TYPE: return createThoroughfareType();
			case _0Package.XAL_TYPE: return createXALType();
			default:
	...
	public DependentThoroughfaresType createDependentThoroughfaresTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createDependentThoroughfaresTypeFromString(_0Package.eINSTANCE.getDependentThoroughfaresType(), initialValue);
	}
	...
	public String convertDependentThoroughfaresTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertDependentThoroughfaresTypeToString(_0Package.eINSTANCE.getDependentThoroughfaresType(), instanceValue);
	}
	...
	public IndicatorOccurenceType createIndicatorOccurenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurenceTypeFromString(_0Package.eINSTANCE.getIndicatorOccurenceType(), initialValue);
	}
	...
	public String convertIndicatorOccurenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurenceTypeToString(_0Package.eINSTANCE.getIndicatorOccurenceType(), instanceValue);
	}
	...
	public IndicatorOccurrenceType1 createIndicatorOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurrenceType1FromString(_0Package.eINSTANCE.getIndicatorOccurrenceType1(), initialValue);
	}
	...
	public String convertIndicatorOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurrenceType1ToString(_0Package.eINSTANCE.getIndicatorOccurrenceType1(), instanceValue);
	}
	 ...
	 * @generated
	 */
	public IndicatorOccurrenceType3 createIndicatorOccurrenceTypeObject1FromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurrenceType3FromString(_0Package.eINSTANCE.getIndicatorOccurrenceType3(), initialValue);
	}
	...
	public String convertIndicatorOccurrenceTypeObject1ToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurrenceType3ToString(_0Package.eINSTANCE.getIndicatorOccurrenceType3(), instanceValue);
	}
	 ...
	 * @generated
	 */
	public IndicatorOccurrenceType2 createIndicatorOccurrenceTypeObject2FromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurrenceType2FromString(_0Package.eINSTANCE.getIndicatorOccurrenceType2(), initialValue);
	}
	...
	public String convertIndicatorOccurrenceTypeObject2ToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurrenceType2ToString(_0Package.eINSTANCE.getIndicatorOccurrenceType2(), instanceValue);
	}
	 ...
	 * @generated
	 */
	public IndicatorOccurrenceType createIndicatorOccurrenceTypeObject3FromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurrenceTypeFromString(_0Package.eINSTANCE.getIndicatorOccurrenceType(), initialValue);
	}
	...
	public String convertIndicatorOccurrenceTypeObject3ToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurrenceTypeToString(_0Package.eINSTANCE.getIndicatorOccurrenceType(), instanceValue);
	}
	...
	public IndicatorOccurrenceType4 createIndicatorOccurrenceTypeObject4FromString(EDataType eDataType, String initialValue) {
		return createIndicatorOccurrenceType4FromString(_0Package.eINSTANCE.getIndicatorOccurrenceType4(), initialValue);
	}
	...
	public String convertIndicatorOccurrenceTypeObject4ToString(EDataType eDataType, Object instanceValue) {
		return convertIndicatorOccurrenceType4ToString(_0Package.eINSTANCE.getIndicatorOccurrenceType4(), instanceValue);
	}
	...
	public NameNumberOccurrenceType createNameNumberOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNameNumberOccurrenceTypeFromString(_0Package.eINSTANCE.getNameNumberOccurrenceType(), initialValue);
	}
	...
	public String convertNameNumberOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNameNumberOccurrenceTypeToString(_0Package.eINSTANCE.getNameNumberOccurrenceType(), instanceValue);
	}
	...
	public NumberOccurrenceType createNumberOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNumberOccurrenceTypeFromString(_0Package.eINSTANCE.getNumberOccurrenceType(), initialValue);
	}
	...
	public String convertNumberOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNumberOccurrenceTypeToString(_0Package.eINSTANCE.getNumberOccurrenceType(), instanceValue);
	}
	...
	public NumberRangeOccurenceType createNumberRangeOccurenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNumberRangeOccurenceTypeFromString(_0Package.eINSTANCE.getNumberRangeOccurenceType(), initialValue);
	}
	...
	public String convertNumberRangeOccurenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNumberRangeOccurenceTypeToString(_0Package.eINSTANCE.getNumberRangeOccurenceType(), instanceValue);
	}
	...
	public NumberRangeOccurrenceType createNumberRangeOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNumberRangeOccurrenceTypeFromString(_0Package.eINSTANCE.getNumberRangeOccurrenceType(), initialValue);
	}
	...
	public String convertNumberRangeOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNumberRangeOccurrenceTypeToString(_0Package.eINSTANCE.getNumberRangeOccurrenceType(), instanceValue);
	}
	...
	public NumberTypeOccurrenceType createNumberTypeOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNumberTypeOccurrenceTypeFromString(_0Package.eINSTANCE.getNumberTypeOccurrenceType(), initialValue);
	}
	...
	public String convertNumberTypeOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNumberTypeOccurrenceTypeToString(_0Package.eINSTANCE.getNumberTypeOccurrenceType(), instanceValue);
	}
	...
	public NumberTypeOccurrenceType1 createNumberTypeOccurrenceTypeObject1FromString(EDataType eDataType, String initialValue) {
		return createNumberTypeOccurrenceType1FromString(_0Package.eINSTANCE.getNumberTypeOccurrenceType1(), initialValue);
	}
	...
	public String convertNumberTypeOccurrenceTypeObject1ToString(EDataType eDataType, Object instanceValue) {
		return convertNumberTypeOccurrenceType1ToString(_0Package.eINSTANCE.getNumberTypeOccurrenceType1(), instanceValue);
	}
	...
	public NumberTypeType createNumberTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createNumberTypeTypeFromString(_0Package.eINSTANCE.getNumberTypeType(), initialValue);
	}
	...
	public String convertNumberTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertNumberTypeTypeToString(_0Package.eINSTANCE.getNumberTypeType(), instanceValue);
	}
	...
	public NumberTypeType1 createNumberTypeTypeObject1FromString(EDataType eDataType, String initialValue) {
		return createNumberTypeType1FromString(_0Package.eINSTANCE.getNumberTypeType1(), initialValue);
	}
	...
	public String convertNumberTypeTypeObject1ToString(EDataType eDataType, Object instanceValue) {
		return convertNumberTypeType1ToString(_0Package.eINSTANCE.getNumberTypeType1(), instanceValue);
	}
	...
	public RangeTypeType createRangeTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createRangeTypeTypeFromString(_0Package.eINSTANCE.getRangeTypeType(), initialValue);
	}
	...
	public String convertRangeTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertRangeTypeTypeToString(_0Package.eINSTANCE.getRangeTypeType(), instanceValue);
	}
	...
	public TypeOccurrenceType createTypeOccurrenceTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTypeOccurrenceTypeFromString(_0Package.eINSTANCE.getTypeOccurrenceType(), initialValue);
	}
	...
	public String convertTypeOccurrenceTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTypeOccurrenceTypeToString(_0Package.eINSTANCE.getTypeOccurrenceType(), instanceValue);
	}
	...
	public TypeOccurrenceType1 createTypeOccurrenceTypeObject1FromString(EDataType eDataType, String initialValue) {
		return createTypeOccurrenceType1FromString(_0Package.eINSTANCE.getTypeOccurrenceType1(), initialValue);
	}
	...
	public String convertTypeOccurrenceTypeObject1ToString(EDataType eDataType, Object instanceValue) {
		return convertTypeOccurrenceType1ToString(_0Package.eINSTANCE.getTypeOccurrenceType1(), instanceValue);
	}
	...
	public TypeOccurrenceType2 createTypeOccurrenceTypeObject2FromString(EDataType eDataType, String initialValue) {
		return createTypeOccurrenceType2FromString(_0Package.eINSTANCE.getTypeOccurrenceType2(), initialValue);
	}
	...
	public String convertTypeOccurrenceTypeObject2ToString(EDataType eDataType, Object instanceValue) {
		return convertTypeOccurrenceType2ToString(_0Package.eINSTANCE.getTypeOccurrenceType2(), instanceValue);
	}
