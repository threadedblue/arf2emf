...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.IndicatorOccurrenceType4;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.NumberOccurrenceType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.NumberTypeType1;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getIndicatorOccurrence <em>Indicator Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getNumberOccurrence <em>Number Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getNumberType <em>Number Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.ThoroughfareNumberTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThoroughfareNumberTypeImpl extends MinimalEObjectImpl.Container implements ThoroughfareNumberType {
	/**
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getThoroughfareNumberType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, _0Package.THOROUGHFARE_NUMBER_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setCode(Object newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__CODE, oldCode, code));
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setIndicatorOccurrence(IndicatorOccurrenceType4 newIndicatorOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, indicatorOccurrence, !oldIndicatorOccurrenceESet));
	}
	...
	public void unsetIndicatorOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_TYPE__INDICATOR_OCCURRENCE, oldIndicatorOccurrence, INDICATOR_OCCURRENCE_EDEFAULT, oldIndicatorOccurrenceESet));
	}
	...
	public void setNumberOccurrence(NumberOccurrenceType newNumberOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_OCCURRENCE, oldNumberOccurrence, numberOccurrence, !oldNumberOccurrenceESet));
	}
	...
	public void unsetNumberOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_OCCURRENCE, oldNumberOccurrence, NUMBER_OCCURRENCE_EDEFAULT, oldNumberOccurrenceESet));
	}
	...
	public void setNumberType(NumberTypeType1 newNumberType) {
		...
		numberTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_TYPE, oldNumberType, numberType, !oldNumberTypeESet));
	}
	...
	public void unsetNumberType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_TYPE, oldNumberType, NUMBER_TYPE_EDEFAULT, oldNumberTypeESet));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.THOROUGHFARE_NUMBER_TYPE__TYPE, oldType, type));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.THOROUGHFARE_NUMBER_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.THOROUGHFARE_NUMBER_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case _0Package.THOROUGHFARE_NUMBER_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.THOROUGHFARE_NUMBER_TYPE__CODE:
				return getCode();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__INDICATOR_OCCURRENCE:
				return getIndicatorOccurrence();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_OCCURRENCE:
				return getNumberOccurrence();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__NUMBER_TYPE:
				return getNumberType();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__TYPE:
				return getType();
			case _0Package.THOROUGHFARE_NUMBER_TYPE__ANY_ATTRIBUTE:
