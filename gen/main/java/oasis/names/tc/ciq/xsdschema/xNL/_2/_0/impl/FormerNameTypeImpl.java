...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Former Name Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xNL._2._0.impl.FormerNameTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xNL._2._0.impl.FormerNameTypeImpl#getValidFrom <em>Valid From</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xNL._2._0.impl.FormerNameTypeImpl#getValidTo <em>Valid To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormerNameTypeImpl extends PersonNameImpl implements FormerNameType {
	/**
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.FORMER_NAME_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _0Package.FORMER_NAME_TYPE__ANY);
		}
		return any;
	}
	...
	public void setValidFrom(Object newValidFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.FORMER_NAME_TYPE__VALID_FROM, oldValidFrom, validFrom));
	}
	...
	public void setValidTo(Object newValidTo) {
		...
		validTo = newValidTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.FORMER_NAME_TYPE__VALID_TO, oldValidTo, validTo));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.FORMER_NAME_TYPE__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.FORMER_NAME_TYPE__VALID_FROM:
				return getValidFrom();
			case _0Package.FORMER_NAME_TYPE__VALID_TO:
				return getValidTo();
		}
