...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.IndicatorOccurenceType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.NumberRangeOccurenceType;
import oasis.names.tc.ciq.xsdschema.xAL._2._0.PremiseNumberRangeFromType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getPremiseNumberRangeFrom <em>Premise Number Range From</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getPremiseNumberRangeTo <em>Premise Number Range To</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getIndicatorOccurence <em>Indicator Occurence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getNumberRangeOccurence <em>Number Range Occurence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getSeparator <em>Separator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.PremiseNumberRangeTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PremiseNumberRangeTypeImpl extends MinimalEObjectImpl.Container implements PremiseNumberRangeType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getPremiseNumberRangeType();
	}
	...
	public NotificationChain basicSetPremiseNumberRangeFrom(PremiseNumberRangeFromType newPremiseNumberRangeFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_FROM, oldPremiseNumberRangeFrom, newPremiseNumberRangeFrom);
	...
	public void setPremiseNumberRangeFrom(PremiseNumberRangeFromType newPremiseNumberRangeFrom) {
		if (newPremiseNumberRangeFrom != premiseNumberRangeFrom) {
			...
			if (premiseNumberRangeFrom != null)
				msgs = ((InternalEObject)premiseNumberRangeFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_FROM, null, msgs);
			if (newPremiseNumberRangeFrom != null)
				msgs = ((InternalEObject)newPremiseNumberRangeFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_FROM, null, msgs);
			msgs = basicSetPremiseNumberRangeFrom(newPremiseNumberRangeFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_FROM, newPremiseNumberRangeFrom, newPremiseNumberRangeFrom));
	}
	...
	public NotificationChain basicSetPremiseNumberRangeTo(PremiseNumberRangeToType newPremiseNumberRangeTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_TO, oldPremiseNumberRangeTo, newPremiseNumberRangeTo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPremiseNumberRangeTo(PremiseNumberRangeToType newPremiseNumberRangeTo) {
		if (newPremiseNumberRangeTo != premiseNumberRangeTo) {
			...
			if (premiseNumberRangeTo != null)
				msgs = ((InternalEObject)premiseNumberRangeTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_TO, null, msgs);
			if (newPremiseNumberRangeTo != null)
				msgs = ((InternalEObject)newPremiseNumberRangeTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_TO, null, msgs);
			msgs = basicSetPremiseNumberRangeTo(newPremiseNumberRangeTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_TO, newPremiseNumberRangeTo, newPremiseNumberRangeTo));
	}
	...
	public void setIndicator(Object newIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__INDICATOR, oldIndicator, indicator));
	}
	...
	public void setIndicatorOccurence(IndicatorOccurenceType newIndicatorOccurence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__INDICATOR_OCCURENCE, oldIndicatorOccurence, indicatorOccurence, !oldIndicatorOccurenceESet));
	}
	...
	public void unsetIndicatorOccurence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.PREMISE_NUMBER_RANGE_TYPE__INDICATOR_OCCURENCE, oldIndicatorOccurence, INDICATOR_OCCURENCE_EDEFAULT, oldIndicatorOccurenceESet));
	}
	...
	public void setNumberRangeOccurence(NumberRangeOccurenceType newNumberRangeOccurence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURENCE, oldNumberRangeOccurence, numberRangeOccurence, !oldNumberRangeOccurenceESet));
	}
	...
	public void unsetNumberRangeOccurence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.PREMISE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURENCE, oldNumberRangeOccurence, NUMBER_RANGE_OCCURENCE_EDEFAULT, oldNumberRangeOccurenceESet));
	}
	...
	public void setRangeType(Object newRangeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__RANGE_TYPE, oldRangeType, rangeType));
	}
	...
	public void setSeparator(Object newSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__SEPARATOR, oldSeparator, separator));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.PREMISE_NUMBER_RANGE_TYPE__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_FROM:
				return basicSetPremiseNumberRangeFrom(null, msgs);
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__PREMISE_NUMBER_RANGE_TO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__INDICATOR:
				return getIndicator();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__INDICATOR_OCCURENCE:
				return getIndicatorOccurence();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__NUMBER_RANGE_OCCURENCE:
				return getNumberRangeOccurence();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__RANGE_TYPE:
				return getRangeType();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__SEPARATOR:
				return getSeparator();
			case _0Package.PREMISE_NUMBER_RANGE_TYPE__TYPE:
				return getType();
		}
