...
import oasis.names.tc.ciq.xsdschema.xAL._2._0.NameNumberOccurrenceType;
 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityNumberTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityNumberTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityNumberTypeImpl#getNameNumberOccurrence <em>Name Number Occurrence</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL._2._0.impl.DependentLocalityNumberTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependentLocalityNumberTypeImpl extends MinimalEObjectImpl.Container implements DependentLocalityNumberType {
	...
	protected EClass eStaticClass() {
		return _0Package.eINSTANCE.getDependentLocalityNumberType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setCode(Object newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__CODE, oldCode, code));
	}
	...
	public void setNameNumberOccurrence(NameNumberOccurrenceType newNameNumberOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__NAME_NUMBER_OCCURRENCE, oldNameNumberOccurrence, nameNumberOccurrence, !oldNameNumberOccurrenceESet));
	}
	...
	public void unsetNameNumberOccurrence() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__NAME_NUMBER_OCCURRENCE, oldNameNumberOccurrence, NAME_NUMBER_OCCURRENCE_EDEFAULT, oldNameNumberOccurrenceESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__CODE:
				return getCode();
			case _0Package.DEPENDENT_LOCALITY_NUMBER_TYPE__NAME_NUMBER_OCCURRENCE:
