...
public class _1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case _1Package.RELATIONSHIPS_CONTAINER_TYPE: {
				RelationshipsContainerType relationshipsContainerType = (RelationshipsContainerType)theEObject;
				T result = caseRelationshipsContainerType(relationshipsContainerType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case _1Package.RELATIONSHIPS_TYPE: {
				RelationshipsType relationshipsType = (RelationshipsType)theEObject;
				T result = caseRelationshipsType(relationshipsType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case _1Package.RELATIONSHIP_TYPE: {
