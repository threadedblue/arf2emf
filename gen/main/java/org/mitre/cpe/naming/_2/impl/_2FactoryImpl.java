...
public class _2FactoryImpl extends EFactoryImpl implements _2Factory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case _2Package.CPE22_TYPE:
				return createCpe22TypeFromString(eDataType, initialValue);
			case _2Package.CPE23_TYPE:
				return createCpe23TypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case _2Package.CPE22_TYPE:
				return convertCpe22TypeToString(eDataType, instanceValue);
			case _2Package.CPE23_TYPE:
				return convertCpe23TypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public String createCpe22TypeFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertCpe22TypeToString(EDataType eDataType, Object instanceValue) {
	 ...
	 * @generated
	 */
	public String createCpe23TypeFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertCpe23TypeToString(EDataType eDataType, Object instanceValue) {
